    ...
    >
      <header className="relative w-full h-[554px] object-cover ">
        ...
        <div className="w-full flex flex-col gap-6 text-white absolute bottom-0 md:bottom-20 md:px-20 px-5">
          <h1 className="text-3xl font-[600]">{theMovie.title}</h1>
          <div className="flex justify-between">
            <div className="flex gap-4 items-center">
              <button
                onClick={handleClickMulai}
                className="px-6 py-2 bg-blue-700 hover:bg-blue-500 rounded-full cursor-pointer"
              >
                Mulai
              </button>
      ...
      <article className="text-white bg-black gap-2 md:px-20 pl-2 md:py-6 md:flex w-full">
        <div className=" md:w-1/2 pl-4 md:pl-0">
          <div className=" flex gap-4 text-gray-300 items-center">
            ...
            <button className="border-1 w-12 h-6 text-base ">
              {theMovie.rating}
            </button>
          </div>
          <p className="pr-10">{theMovie.description}</p>
        </div>
        <div className="md:w-1/2 pl-4  pt-2 pr-2">
          <div className="grid grid-cols-[auto_1fr] gap-x-2">
            ...
            <p className="text-white">{theMovie.cast.join(", ")}</p>
          </div>
          <div className="grid grid-cols-[auto_1fr] gap-x-2">
            {" "}
            <h1 className="text-gray-300 whitespace-nowrap">
